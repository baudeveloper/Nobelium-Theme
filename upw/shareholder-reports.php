...
<?php printf( __( '<h2 class="widget-title">Shareholder<br>Reports</h2>', 'nobelium' ), '/' ); ?>
...
<?php if ($upw_query->have_posts()) : ?>
  <?php while ($upw_query->have_posts()) : $upw_query->the_post(); ?>
    ...
    <?php endwhile; ?>
    <!-- <div class="more"> -->
      <?php //printf( __( '<a href="/shareholder-reports/" class="btn btn-secondary"><i class="fa fa-chevron-right" aria-hidden="true"></i> More</a>', 'nobelium' ), '/' ); ?>
    <!-- </div> -->
<?php else : ?>
