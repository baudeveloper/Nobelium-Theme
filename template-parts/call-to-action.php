...
<section class="intro-section clearfix">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<?php if ( is_singular( 'financial-news' ) ) { ?>
				...
				<?php } else if ( is_singular( 'shareholder-reports' ) ) { ?>
					<h1><?php esc_html_e( 'Reports', 'nobelium' ); ?></h1>
				<?php } else if ( is_singular( 'management-ppts' ) ) { ?>
					<h1><?php esc_html_e( 'Presentations', 'nobelium' ); ?></h1>
				<?php } else { ?>
				<h1><?php the_title(); ?></h1>
				<?php } ?>
			</div>
